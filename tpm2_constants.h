#ifndef TPM2_CONSTANTS_H
#define TPM2_CONSTANTS_H

namespace tpm2
{

//Port for TMM2.Net communication
static const int TPM2_NET_PORT					    = 65506;
//50200
//Header Bytes
static const char TPM2_SER_BLOCK_START_BYTE = 0xC9; // 'NEW BLOCK BYTE' for TPM2.Serial
static const char TPM2_NET_BLOCK_START_BYTE = 0x9C; // 'NEW BLOCK BYTE' for TPM2.Net
static const char TPM2_BLOCK_TYPE_DATA      = 0xDA; // Block is a  'DATA BLOCK'
...
static const char TPM2_BLOCK_END_BYTE       = 0x36; // Last Byte of a TMP2 Block
//Header & footer size
